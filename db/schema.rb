...
ActiveRecord::Schema.define(version: 20170727172302) do
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.index ["magic_id"], name: "index_comments_on_magic_id", using: :btree
  ...
  add_foreign_key "comments", "magics"
  add_foreign_key "comments", "users"
  add_foreign_key "magics", "topics"
